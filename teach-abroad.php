...
<!-- End Google Tag Manager -->
    ...
    <meta name="description" content="AIESEC Global Entrepreneur Sign Up">
    <script async type="text/javascript" src="//ajax.googleapis.com/ajax/libs/jquery/2.0.0/jquery.min.js"></script>
...
<!-- End Google Tag Manager (noscript) -->
    <div class="page-wrapper bg-gra-04 p-t-100 p-b-100 font-poppins" style="background: linear-gradient(to top right, #F48924 0%, #F48924 100%);">
     <center>   <img src="Aiesecwhiteblue.png" onclick="window.location='https://www.aiesec.lk';" alt="Smiley face" class="responsive" > </center><br><br>
        <div class="wrapper wrapper--w680">
            <div class="card card-4">
                <div class="card-body">
                    <center><h2 class="title" style="color:#F48924;"> Global Teacher Sign Up</h2></center>
                    <form id='signup_form'  >
                        ...
                        <div class="input-group">
                            <label class="label">University / Institute or Other</label>
                            <div class="rs-select2 js-select-simple ">
                                                                <select name="institute" id="institute" required>
                                    <option disabled="disabled" value="" selected hidden>Choose option</option>
									<?php
										echo file_get_contents("alignments.txt");
									?>
                                </select>
                                <div class="select-dropdown"></div>
                            </div>
                        ...
                        <div class="p-t-15">
                            <button class="btn btn--radius-2 btn--ge" style="background: #F48924;" name="submit" type="submit">Sign Up
