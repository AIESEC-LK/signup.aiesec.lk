                                                                                                        ...
                                                                                                        <label class="label">University / Institute or Other</label>
                                                                                                                        <div class="rs-select2 js-select-simple ">
                                                                                                                            <select name="institute" id="institute" required>
                                                                                                                                <option value="" disabled="disabled" selected="selected" hidden>Choose option</option>
                                                                                            									<?php
...
$(function () {
        $('form').on('submit', function (e) {
           console.log($('form').serialize()+"&alignment="+($("#institute").children('option:selected').data('id')));
