...
if ($jsonResponse->success === true) {
    create_ep($lastname, $firstname, $email ,$phone, $password, $referral , $lc, $alignment, $productid,$group, $trace);
}
else {
...
function create_ep($lastname, $firstname, $email ,$phone, $password, $referral , $lc, $alignment,$productid,$group, $trace ){
...
function post_slack($id,$firstname,$epid,$referral)
{
    ...
    $data = array (
        'text' => 'Hello there, There is a new '.$prodcut.' landing page Sign up => '.$firstname.' | EP ID => '.$epid.' | From => '.$referral );
...
function post_lb_slack($id,$lc_code,$firstname,$epid,$referral)
{
    if ($id=='7'){
        $prodcut='OGV';
    }
    ...
    $data = array (
        'text' => 'Hello there, There is a new '.$prodcut.' landing page Signup => '.$firstname.' | EP ID => '.$epid .' | From => '.$referral);
